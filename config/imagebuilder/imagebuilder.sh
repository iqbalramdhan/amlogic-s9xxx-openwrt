...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        luci-theme-material px5g-mbedtls rpcd rpcd-mod-file rpcd-mod-iwinfo rpcd-mod-luci \
        ...
        kmod-usb-acm kmod-usb-net-cdc-ncm comgt usb-modeswitch usbutils \
        r8152-firmware btrfs-progs comgt-ncm zoneinfo-asia \
        ${config_list} \
        "
